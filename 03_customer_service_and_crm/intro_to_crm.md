...
**Illustration**: Interaction tracking is like a conversation log. It’s a diary of every chat you’ve had with a friend (customer), so you never lose track.

### 3. Automation
**What it is**: Using CRM to automate tasks like sending emails, scheduling follow-ups, or assigning support tickets.

**Example**: A gym’s CRM sends a welcome email when you sign up online via your Windows computer. On your Android phone, you get a reminder about your first class, automated by the CRM.
...
Let’s explore CRM with fun activities on your **Windows computer** or **Android phone**. These are beginner-friendly and include comparisons to macOS, iOS, or Linux.
...
4. Write down:  
   - The store and CRM feature (e.g., “Suggested items”).  
   - How it helps (e.g., “Personalizes shopping”).  
**Steps (Android)**:  
...
4. Write down:  
   - The profile details.  
   - How it helps a business (e.g., “Tracks customer preferences”).  
**Steps (Android)**:  
...
2. Write a short automated email for a pretend business (e.g., “Thanks for shopping at our store! Here’s 10% off your next order.”).  
3. Write down:  
   - The email.  
   - How automation helps (e.g., “Saves time”).  
**Steps (Android)**:  
