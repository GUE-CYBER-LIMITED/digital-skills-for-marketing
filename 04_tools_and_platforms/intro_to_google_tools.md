...
**Google Tools** (part of Google Workspace, formerly G Suite) are like a **digital toolbox** filled with apps that help you work, collaborate, and store files online. These cloud-based tools run in your browser or as apps, making them accessible anywhere with an internet connection.

Think of Google Tools as running a community center:
- Your **projects** (documents, spreadsheets) are events you plan.
- **Google Tools** are the rooms and supplies (apps) you use to organize.
- Your **team** (friends or coworkers) collaborates using these tools on phones or computers.

Popular Google Tools include Google Docs (word processing), Google Sheets (spreadsheets), Google Slides (presentations), Google Drive (file storage), and Gmail (email).

### Why are Google Tools Important?
Google Tools matter because they:
- **Are Free and Accessible**: Use them with a Google account on any device.
- **Enable Collaboration**: Multiple people can edit files in real-time.
- **Save Automatically**: Your work is stored in the cloud, so no data loss.
- **Integrate Easily**: Work with other tools like Zendesk or Excel (from Modules 3 and 4).
...
2. **Create**: Start a new document, spreadsheet, or presentation.  
   - Example: Write a letter in Google Docs.

3. **Collaborate**: Share the file with others to edit or comment in real-time.  
   - Example: Invite a friend to edit your Google Sheet.

4. **Store**: Files save automatically to Google Drive.  
   - Example: Your letter is stored in Drive, accessible on your Android phone.

5. **Access Anywhere**: Open files on any device with internet.  
   - Example: View your presentation on your phone during a meeting.

**Illustration**: Google Tools are like a shared kitchen:  
- **Sign In**: Enter the kitchen (Google account).  
- **Create**: Cook a dish (document).  
- **Collaborate**: Cook with friends (edit together).  
- **Store**: Put leftovers in the fridge (Drive).  
- **Access**: Grab a snack later (use on any device).
...
- Document: Hobby Note, Content: My favorite hobby is reading!  
- Useful: Easy to write and save, no need for a USB.  
- Difference: iOS Docs app might have smoother touch controls.  

**Example Answer (Android)**:  
- Document: Fun Note, Content: I love hiking on weekends!  
- Useful: Auto-saves and accessible anywhere.  
- Difference: Linux browsers might show plainer menus.

### Activity 2: Share a File on Google Drive
**Goal**: Practice using Google Drive.  
**Steps (Windows)**:  
...
3. Share it via email or link.  
4. Write down:  
   - The file and sharing details.  
   - How Drive helps.  
...
**Example Answer (Android)**:  
- File: Fun Note, Shared: Link  
- Help: Lets me access files on any device.  
- Difference: Linux Drive might show larger icons.

### Activity 3: Try Google Sheets
...
3. Write down:  
   - The data and result.  
   - How Sheets helps.  
**Compare**: On iOS or Linux, Sheets is similar. How might the interface differ? Write one difference.

**Example Answer (Windows)**:  
- Data: Coffee $5, Tea $3, Result: $8  
- Help: Calculates totals automatically.  
- Difference: iOS Sheets app might have touch-friendly buttons.  

**Example Answer (Android)**:  
- Data: Book $10, Pen $2, Result: $12  
- Help: Organizes and adds numbers easily.  
- Difference: Linux browsers might load Sheets slower.

---

## Fun Facts About Google Tools
- Google Docs launched in 2006, revolutionizing cloud-based work!  
- Over 2 billion people use Google Workspace tools monthly.  
- Google Drive offers 15 GB of free storage for every account.  
- Real-time collaboration in Docs can handle 100+ editors at once.
