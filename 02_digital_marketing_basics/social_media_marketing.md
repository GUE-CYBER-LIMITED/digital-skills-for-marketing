...
**Social Media Marketing** is like **hosting a party online** to share your brand’s story, products, or ideas. It’s using social media platforms to post content, engage with followers, and grow an audience.
...
**Example**: On your Android phone, you might see a café’s Instagram Story about a new drink. On your Windows computer, you might read a company’s LinkedIn post in a browser.

**Illustration**: Platforms are like different party venues. Instagram is a vibrant club, Twitter is a busy café, and LinkedIn is a formal conference.

### 2. Engagement
**What it is**: Interacting with your audience through likes, comments, shares, or messages to build relationships.

**Example**: A clothing brand replies to a customer’s comment on Instagram, making them feel valued. You might comment on a post from your Android phone or like one on your Windows computer.
...
**Example**: A free Instagram post about a sale is organic; a promoted post targeting local users is paid. You’d see both on your Android phone’s Instagram feed or Windows computer’s browser.
...
Here’s how to run a social media marketing campaign:
...
Let’s try social media marketing with fun activities on your **Windows computer** or **Android phone**. These are easy and include comparisons to other systems.

### Activity 1: Explore a Brand’s Profile
**Goal**: Understand platform use.  
**Steps (Windows)**:  
1. Open a browser and visit a platform like `www.instagram.com` or `www.twitter.com`.  
2. Find a brand’s profile (e.g., Nike, Starbucks).  
3. Note one post and its style (e.g., photo, text).  
4. Write down:  
   - The brand and platform.  
   - The post style and why it works (e.g., “Photo grabs attention”).  
**Steps (Android)**:  
1. Open an app like **Instagram** or **Twitter**.  
2. Find a brand’s profile.  
...
2. Comment on or like a brand’s post (or imagine doing so).  
3. Write down:  
   - The post and your action (real or imagined).  
   - How it helps marketing (e.g., “Shows interest”).  
**Steps (Android)**:  
